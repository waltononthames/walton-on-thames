...
| — | Blueprint 5 `/living/property/` | NEW | Not built. |
| `src/pages/living/areas.astro` | Blueprint 5 `/living/areas/` | NEW | Built 16 September 2026, with a map generated by `scripts/build-areas-map.mjs`. See build log. |
