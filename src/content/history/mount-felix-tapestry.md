...
sources:
  ...
  - label: "Canterbury Museum — The Mount Felix Tapestry at Canterbury Museum"
    url: "https://www.canterburymuseum.com/explore/latest-news/the-mount-felix-tapestry-at-canterbury-museum"
  - label: "Museum of New Zealand Te Papa Tongarewa — Memorial banner record"
    url: "https://collections.tepapa.govt.nz/object/972921"
  - label: "Riverhouse Barn Arts Centre — Mt Felix Tapestry"
...
The panels focus on individuals rather than statistics. One tells the story of Edith "Poppy" Popplewell, a New Zealand nurse who survived the sinking of the hospital ship *Marquette* by a German torpedo on 23 October 1915 and went on to manage a ward at Mount Felix. A companion panel remembers Lorna Rattray, a nurse who did not survive the same sinking, and a further panel follows Hugh Acland, a surgeon who survived the *Marquette* and later became president of the hospital's medical board in 1917. Another panel tells a lighter story: Lance Corporal Alexander Grant, recovering at the hospital, first noticed Walton resident Ruth Rosewell over an ivy-clad wall; the two later married. The surgeon Henry Percy Pickerill, who organised specialist treatment for men with severe facial and jaw injuries, also features.

<!-- IMAGE: mount-felix-tapestry-marquette-panel.jpg — alt: "Mount Felix Tapestry panel telling the story of the nurses of the Marquette" -->

## The tapestry's journey to New Zealand

The finished tapestry toured New Zealand for around 18 months from 2018, shown at museums and cultural venues around the country before returning to Britain in 2019. It has since been shown again in the Elmbridge area, including a 2022 exhibition and a tenth-anniversary display at Riverhouse Barn in 2025.
...
Where the tapestry itself can be seen depends on what is currently on tour or on loan; there is no permanent public display, so anyone hoping to see it in person should check with Riverhouse Barn Arts Centre, where the project began, before visiting specially. For one of the individual stories behind the hospital's patient numbers, see [Arthur White's story](/history/arthur-white/), a gunner treated at Mount Felix in 1917.
