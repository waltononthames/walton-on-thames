...
Walton's Domesday entry of 1086 already records a church here, and while the building visible today is not that Saxon church, it incorporates Saxon material within a fabric that dates in its main structural form to the twelfth century. The result is a building that has been added to, rather than replaced, across roughly nine centuries, which is exactly why it repays a slow look rather than a quick one.
